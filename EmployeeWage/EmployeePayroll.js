...
const emp1 = new EmployeePayroll(101, "Shristy", 50000, "Female", "2023-03-15");  
const emp2 = new EmployeePayroll(102, "Arjun", 47000, "Male", "2003-11-05"); 
const emp3 = new EmployeePayroll(103, "ena", 46000, "Male", "2024-01-20"); 
